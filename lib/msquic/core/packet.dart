...
enum QuicLongHeaderTypeV1 { initial, rtt0Protected, handshake, retry }

enum QuicLongHeaderTypeV2 { retry, initial, rtt0Protected, handshake }
...
const int minShortHeaderLengthV1 =
    1 + 4; // DestCid with max length is not included.

// This is an example of a function signature conversion. The implementation is omitted.
// ` bool QuicPacketIsHandshake(...)` becomes:
