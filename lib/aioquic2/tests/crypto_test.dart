// Filename: test/crypto_test.dart
import 'dart:typed_data';
import 'package:test/test.dart';
import 'package:hex/hex.dart';
import 'package:collection/collection.dart';
import '../crypto2.dart'; // Ensure this points to your final crypto file

void main() {
  final eq = DeepCollectionEquality().equals;

  group('CryptoTest QUIC v1', () {
    ...
    test('decrypt long client', () async {
      ...
      expect(eq(pHeader, clientPlainHeader), isTrue);
      expect(eq(pPayload, clientPlainPayload), isTrue);
      expect(pNum, clientPacketNumber);
    });

    test('encrypt long client', () async {
      final pair = CryptoPair();
      await pair.setupInitial(
        cid: Uint8List.fromList(HEX.decode("8394c8f03e515708")),
        isClient: true,
      ...
      expect(eq(encrypted, clientEncryptedPacket), isTrue);
    });
  });
}
