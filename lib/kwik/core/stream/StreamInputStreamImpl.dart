...
class StreamInputStreamImpl extends StreamInputStream {
    ...
    static long waitForNextFrameTimeout = Long.MAX_VALUE;

    static final float receiverMaxDataIncrementFactor = 0.10f;

    final QuicStreamImpl quicStream;
    volatile  bool closed;
    volatile  bool reset;
    volatile Thread blockingReaderThread;
    final ReceiveBuffer receiveBuffer;
    final Object addMonitor = new Object();
    long lastCommunicatedMaxData;
    final long receiverMaxDataIncrement;
    long largestOffsetReceived;
    long receiverFlowControlLimit;
    volatile  bool aborted;
    volatile long finalSize = -1;

    StreamInputStreamImpl(QuicStreamImpl quicStream, long receiveBufferSize) {
    ...
    @Override
    int read(Uint8List buffer, int offset, int len) throws IOException {
        if (len == 0) {
            return 0;
        }
    ...
    void retransmitStopInput(QuicFrame lostFrame) {
    ...
    void updateAllowedFlowControl(int bytesRead) {
    ...
    void retransmitMaxData(QuicFrame lostFrame) {
