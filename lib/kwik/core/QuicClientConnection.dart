...
interface QuicClientConnection extends QuicConnection {
    ...
    class StreamEarlyData {
        ...
        StreamEarlyData(Uint8List data,  bool closeImmediately) {
            this.data = data;
    ...
    interface Builder {
         ...
         * contain the client's key(s) and certificate(s) it wants to use for authentication.
        ...
        /**
         * Sets the password for the client's key.
         * @param keyPassword
         * @return
         */
