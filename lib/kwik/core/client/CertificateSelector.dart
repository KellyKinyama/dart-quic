...
class CertificateSelector {
    ...
    CertificateSelector(KeyStore keyManager, String keyPassword, Logger log) {
        this.keyStore = keyManager;
        this.keyPassword = keyPassword;
        this.log = log;
    }

    CertificateWithPrivateKey selectCertificate(List<X500Principal> authorities,  bool fallback) {
