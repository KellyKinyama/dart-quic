...
class StopSendingFrame extends QuicFrame {
    ...
    StopSendingFrame(Version quicVersion) {
    }

    StopSendingFrame(Version quicVersion, Integer streamId, Long errorCode) {
        this.streamId = streamId;
        this.errorCode = errorCode;
    }

    StopSendingFrame parse(ByteBuffer buffer, Logger log) throws InvalidIntegerEncodingException, TransportError {
        buffer.get();
