...
class AckFrame extends QuicFrame {
    ...
    static final int FIXED_SENDER_ACK_DELAY_EXPONENT = 3;

    static final int FIXED_SENDER_ACK_DELAY_SCALE = (int) Math.pow(2, FIXED_SENDER_ACK_DELAY_EXPONENT);
    static final int MAX_FRAME_SIZE = 1000;  // Should be large enough; leave some space for packet overhead.

    Uint8List frameBytes;
    long largestAcknowledged;
    int ackDelay;
    List<Range> acknowledgedRanges;
     ...
     */
    AckFrame(Version quicVersion, List<Range> ackRanges, int ackDelayInMillis) {
    ...
    AckFrame parse(ByteBuffer buffer, Logger log) throws InvalidIntegerEncodingException, IntegerTooLargeException, TransportError {
    ...
    int addAcknowledgeRange(long largestOfRange, int rangeSize) throws TransportError {
     ...
     * @return
     */
    Stream<Long> getAckedPacketNumbers() {
     ...
     * @return
     */
    List<Range> getAcknowledgedRanges() {
    ...
    void setDelayExponent(int exponent) {
