...
abstract class QuicFrame {
    ...
    abstract void accept(FrameProcessor frameProcessor, QuicPacket packet, PacketMetaData metaData);
     ...
     */
    int parseVariableLengthIntegerLimitedToInt(ByteBuffer buffer) throws InvalidIntegerEncodingException, TransportError {
        try {
