...
class Range {
     ...
     * @return
     */
    static  bool validRangeList(List<Range> ackRanges) {
     ...
     bool canBeExtendedWith(long number) {
    ...
    Range extendWith(long number, Range next) {
     ...
     */
    static  bool extendRangeList(List<Range> ranges, long number) {
        int index = 0;
     ...
     bool greaterThan(Range other) {
        return this.from > other.to;
    }

     bool lessThan(Range other) {
     ...
     * @return
     */
     bool properlyContains(Range other) {
        return this.from < other.from && this.to > other.to;
    }
    ...
    class StreamElementGenerator implements Supplier<Long> {
