...
class AbstractCongestionController implements CongestionController {
    ...
    static final int initialWindowSize = 10 * 1200;

    final Logger log;
    volatile long bytesInFlight;
    volatile long congestionWindow;
    final CongestionControlEventListener eventListener;

    AbstractCongestionController(Logger logger, CongestionControlEventListener eventListener) {
        this.log = logger;
    ...
    @Override
    synchronized void registerInFlight(QuicPacket sentPacket) {
    ...
    @Override
    synchronized void registerAcked(List<? extends PacketInfo> acknowlegdedPackets) {
    ...
    @Override
    synchronized void registerLost(List<? extends PacketInfo> lostPackets) {
    ...
    @Override
    synchronized void discard(List<? extends PacketInfo> discardedPackets) {
    ...
    synchronized  bool canSend(int bytes) {
