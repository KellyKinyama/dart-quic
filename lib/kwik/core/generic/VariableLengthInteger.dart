...
class VariableLengthInteger {
     ...
     * @deprecated use {@link #parseInt(ByteBuffer)} instead
     */
    @Deprecated
    static int parse(ByteBuffer buffer) throws InvalidIntegerEncodingException {
     ...
     * @throws InvalidIntegerEncodingException
     */
    static int parseInt(ByteBuffer buffer) throws InvalidIntegerEncodingException, IntegerTooLargeException {
        long value = parseLong(buffer);
        if (value <= Integer.MAX_VALUE) {
            return (int) value;
        }
    ...
    static long parseLong(ByteBuffer buffer) throws InvalidIntegerEncodingException {
    ...
    static int parse(InputStream inputStream) throws IOException {
    ...
    static long parseLong(InputStream inputStream) throws IOException {
        long value;
