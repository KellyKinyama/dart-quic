...
class DestinationConnectionIdRegistry extends ConnectionIdRegistry {

    volatile int notRetiredThreshold;  // all sequence numbers below are retired


    DestinationConnectionIdRegistry(Uint8List initialConnectionId, Logger log) {
        super(log);
    ...
    void replaceInitialConnectionId(Uint8List connectionId) {
     ...
     */
     bool registerNewConnectionId(int sequenceNr, Uint8List connectionId, Uint8List statelessResetToken) {
     ...
     * @return
     */
     bool isStatelessResetToken(Uint8List tokenCandidate) {
