...
class ChaCha20 extends BaseAeadImpl {
    ...
    ChaCha20(Version quicVersion, Role server, Logger log) {
    ...
    Uint8List createHeaderProtectionMask(Uint8List sample) {
        try {
            ...
            Uint8List nonce = Arrays.copyOfRange(sample, 4, 16);
            Uint8List counterBytes = new byte[4];
            ...
            Uint8List mask = hpCipher.doFinal(new Uint8List{ 0, 0, 0, 0, 0 });
            return mask;
        } catch (NoSuchAlgorithmException | NoSuchPaddingException e) {
            // Inappropriate runtime environment
            throw new QuicRuntimeException(e);
