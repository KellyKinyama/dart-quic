...
class InetTools {
    ...
    static InetAddress lookupAddress(String hostname, IPversionOption ipVersionOption) throws UnknownHostException {
    ...
    static  bool isIPv4(InetAddress address) {
        return address instanceof Inet4Address;
    }

    static  bool isIPv6(InetAddress address) {
