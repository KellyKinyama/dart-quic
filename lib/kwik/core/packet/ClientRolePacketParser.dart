 ...
 */
class ClientRolePacketParser extends PacketParser {

    volatile Uint8List originalDestinationConnectionId;

    ClientRolePacketParser(ConnectionSecrets secrets, VersionHolder quicVersion, int cidLength, Uint8List originalDestinationConnectionId, PacketFilter processor, BiFunction<ByteBuffer, Exception, Boolean> handleUnprotectPacketFailureFunction, Logger logger) {
    ...
    Aead getAead(QuicPacket packet, ByteBuffer data) throws MissingKeysException, InvalidPacketException {
        Aead aead;
     ...
     */
    void setOriginalDestinationConnectionId(Uint8List originalDestinationConnectionId) {
        this.originalDestinationConnectionId = originalDestinationConnectionId;
    }
}
