...
import "../buffer.dart";
import "../impl/VersionHolder.dart";
import "InitialPacket.dart";
import "PacketParser.dart";
...
class ServerRolePacketParser extends PacketParser {

    final  bool retryRequired;
    final Supplier<QuicConnectionImpl.VersionNegotiationStatus> versionNegotiationStatusSupplier;

    ServerRolePacketParser(ConnectionSecrets secrets, VersionHolder quicVersion, int cidLength,  bool retryRequired,
    ...
    Aead getAead(QuicPacket packet, Buffer data) 
    // throws MissingKeysException, InvalidPacketException, TransportError
     {
        Aead aead;

        if (retryRequired && packet is InitialPacket) {
