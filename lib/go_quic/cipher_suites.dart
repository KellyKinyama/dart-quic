...
class AlgoPair {
  ...
  AlgoPair({required this.hashAlgorithm, required this.signatureAlgorithm});
...
(List<CipherSuiteId>, int, dynamic) decodeCipherSuiteIDs(
  Uint8List buf,
  int offset,
  int arrayLen,
) {
  ...
  offset += 2;
  List<CipherSuiteId> result = List.filled(
    count,
