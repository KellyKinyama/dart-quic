...
//     buffer.pushUint8(legacySessionId.length);
//     buffer.pushBytes(legacySessionId);
...
//     }
//     buffer.pushUint16(suitesBuffer.toBytes().length);
//     buffer.pushBytes(suitesBuffer.toBytes());
